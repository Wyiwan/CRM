...
<script type="text/javascript">
	...
	function deleteByPid(pid) {
		...
		if (confirm("确定要删除这个商品吗？")) {
			...
			location.href = "${pageContext.request.contextPath}/adminProduct?method=delete&pid="
					+ pid;
		}
	}
</script>
							...
							<c:forEach items="${list }" var="p" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/adminProduct?method=getProByPid&pid=${p.pid}">
											<img src="${pageContext.request.contextPath}/img2/edit.png"
											border="0" style="CURSOR: hand">
									</a></td>

									<td align="center" style="HEIGHT: 22px"><a
										href="javascript:void(0)" onclick="deleteByPid('${p.pid}')">
