	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="./index.htm">首页&nbsp;&nbsp;&gt;</a> <a href="#">家用电器&nbsp;&nbsp;&gt;</a>
				<a>洗衣机</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					<form id=frmId action="${pageContext.request.contextPath }/cart?method=add" method="post">
			...
			<div style="width: 950px; margin: 0 auto;">
				<div
					...
					<strong>商品介绍</strong> ${bean.pdesc }
				</div>

				<div>
					<img
						src="${pageContext.request.contextPath}/img/bg.jpg">
				</div>
